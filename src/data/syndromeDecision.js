...
const SYNDROME_DECISION = {
  ...
  cystitis: {
    ...
    objections: [
      { q: "Why nitrofurantoin 5 d and not the 7 d I see prescribed?",
        a: "Gupta IDSA 2010 [cite:balance] anchors nitrofurantoin 5 d as non-inferior to longer regimens for uncomplicated cystitis cure, with lower adverse-event rates. Huttner (JAMA 2018) confirmed nitrofurantoin 5 d cure 70% vs fosfomycin single-dose 58% — the 5-day course is the validated standard. Extending to 7 d adds GI intolerance and pulmonary toxicity exposure without changing cure. Reserve longer courses for complicated UTI, pyelonephritis suspicion, or recurrence." },
      { q: "Why fosfomycin single-dose when symptoms persist at 48 h?",
        a: "Fosfomycin's pharmacokinetics rely on bladder reservoir effect — a single 3 g sachet achieves urinary concentrations adequate for ≥ 48 h cidal activity. Repeat dosing does not improve cure per Huttner (JAMA 2018) [cite:balance], but adds cost without benefit. Symptom persistence at 48–72 h triggers reculture and reassessment for pyelonephritis or resistant organism, not reflexive re-dosing. Switch agent rather than extend fosfomycin." },
      { q: "Why not empiric ciprofloxacin — it always works?",
        a: "Empiric fluoroquinolone is deliberately second-line per Gupta IDSA 2010 and Nicolle IDSA 2019 [cite:balance]. FQ carries tendon rupture, aortic dissection, QT, and CNS toxicity that outweigh modest cure advantage in uncomplicated cystitis. More importantly, FQ exposure selects for C. difficile and ESBL Enterobacterales — the collateral resistance damage outlasts the patient's three-day prescription. Reserve FQ for pyelonephritis or proven first-line failure." },
      { q: "Why treat asymptomatic bacteriuria in pregnancy but not elderly?",
        a: "Pregnancy ASB is a validated treatment indication per Nicolle IDSA 2019 [cite:balance] — untreated ASB drives preterm birth and pyelonephritis risk that the meta-analyses consistently confirm. Elderly, catheterized, and diabetic ASB are explicit do-not-treat populations because antibiotic exposure drives resistance, AKI, and C. difficile without preventing symptomatic UTI. Cloudy urine and isolated mental-status change are not treatment indications — broader workup precedes antibiotics in the elderly." },
    ],
    research: {
  ...
  cauti: {
    ...
    objections: [
      { q: "Why change the catheter — antibiotics alone should clear it?",
        a: "Catheter biofilm renders antibiotics only partially effective — sessile organisms within the polymeric matrix evade β-lactam killing, and the biofilm continuously re-seeds the bladder. Hooton IDSA 2010 [cite:balance] mandates catheter removal or exchange as the source-control intervention, with the antibiotic clock starting from the change day. Without exchange, recurrence is the rule. Cultures must be drawn from the new catheter — old-catheter samples reflect biofilm colonization, not bladder infection." },
      { q: "Why 7 d and not the historical 14 d?",
        a: "Hooton IDSA 2010 [cite:balance] anchors 7 d for prompt response after catheter exchange, with 10–14 d only for delayed response or catheter retained. The BALANCE short-course principle extends to the CAUTI substrate once source control is achieved. Extending beyond 7 d in a responding patient drives resistance, AKI, and C. difficile without measurable benefit. Reserve longer courses for ESBL, Pseudomonas, MDR organisms, or biofilm-persistent infection." },
      { q: "Why not treat the asymptomatic catheter-associated bacteriuria?",
        a: "Trautner CID 2014 + Nicolle IDSA 2019 [cite:balance] explicitly recommend against treating catheter-associated ASB — antibiotic exposure drives resistance, AKI, and C. difficile without preventing symptomatic CAUTI. Cloudy urine, odor, and isolated mental-status change are not treatment indications. The only validated exceptions are pregnancy and pre-urologic-procedure (single dose ~30 min before). Stewardship displaces reflexive prescription." },
    ],
    research: {
  ...
  prostatitis: {
    ...
    objections: [
      { q: "Why 4 weeks for acute prostatitis — that seems excessive?",
        a: "The inflamed prostate transiently admits agents that the chronic gland excludes, but the inflammation resolves while organisms persist in deeper tissue — Naber 2008 and AUA 2024 [cite:balance] anchor 4 wk to prevent progression to chronic bacterial prostatitis. Truncating to 7–14 d (the standard UTI course) drives 30–40% relapse rates in chronic disease. Lipsky CID 2010 confirmed 6 wk over 4 wk improves cure for chronic disease. The duration is the prophylaxis against chronicity." },
      { q: "Why not cephalexin — it works for cystitis?",
        a: "β-lactams have poor prostatic penetration once acute inflammation subsides — cephalexin, amoxicillin-clavulanate, and oral cefixime achieve inadequate tissue concentrations for prolonged therapy per Naber 2008 [cite:balance]. The only adequate oral step-down options for the chronic prostate are fluoroquinolone (ciprofloxacin, levofloxacin) and TMP-SMX, both of which achieve favorable prostatic tissue:serum ratios. Using a β-lactam for step-down guarantees relapse within weeks of completion." },
      { q: "Why FQ if community E. coli FQ-resistance is > 30%?",
        a: "Rising community FQ-resistance does not eliminate FQ as a class — it mandates susceptibility-driven choice per Lipsky CID 2010 + AUA 2024 [cite:balance]. Local antibiogram review before committing to a 4–6 wk course is the stewardship contract; TMP-SMX is the alternative tissue-penetrating agent for FQ-resistant isolates. Empiric IV ceftriaxone bridges until susceptibilities return. Refusing FQ outright leaves only TMP-SMX and limits options when sensitivity is documented." },
      { q: "Why avoid prostatic massage in acute disease?",
        a: "Massage of an acutely inflamed prostate seeds bacteremia — the inflamed gland releases organisms into the systemic circulation, and AUA 2024 [cite:balance] explicitly contraindicates massage and instrumentation in acute disease. Meares-Stamey localization is reserved for chronic workup once acute inflammation has resolved. TRUS for abscess workup is permissible and indication-driven. The bacteremia risk from massage is non-trivial and avoidable." },
    ],
    research: {
  ...
  urosepsis: {
    ...
    objections: [
      { q: "Why decompression before antibiotic escalation?",
        a: "Antibiotics fail with an obstructed kidney — drug delivery to the infected parenchyma is blunted, and continuous high-grade obstruction drives bacteremia and shock progression. Wagenlehner Lancet 2015 + SSC 2021 [cite:ssc] anchor emergent ureteral stent or percutaneous nephrostomy within 6 h of sepsis recognition as the dominant mortality lever. Each hour of delay compounds mortality. Source control precedes any second-line antibiotic decision." },
      { q: "Why meropenem and not pip-tazo for ESBL urosepsis?",
        a: "MERINO (JAMA 2018) [cite:merino] established meropenem superiority over pip-tazo for ceftriaxone-resistant E. coli / K. pneumoniae bacteremia — 30-d mortality 12.3% vs 3.7%, stopped early. In-vitro pip-tazo susceptibility does not translate to clinical adequacy at the bloodstream-infection inoculum. For ESBL urosepsis with bacteremia, ertapenem (outpatient-eligible) or meropenem is the standard; pip-tazo is reserved for lower-acuity ESBL UTI without bacteremia per IDSA AMR-GN 2024." },
      { q: "Why 7 d when prior teaching was 14 d?",
        a: "BALANCE NEJM 2025 [cite:balance] established 7 d non-inferior to 14 d in source-controlled GNR bacteremia, including the large urosepsis subset — 90-d mortality equivalent at the 4% margin. The default is short with a defined stop date once decompression is achieved and blood cultures clear. Reserve 14+ d for endovascular focus, undrained source, persistent bacteremia > 72 h, immunocompromise, or ESBL where MERINO did not include." },
    ],
    research: {
  ...
  epididymo: {
    ...
    objections: [
      { q: "Why ceftriaxone plus doxy — isn't one agent enough?",
        a: "Workowski CDC MMWR 2021 [cite:cdc_sti] anchors dual coverage for the STI-driven substrate because N. gonorrhoeae and C. trachomatis co-infection is the rule, not the exception. Ceftriaxone 500 mg IM × 1 covers gonococci; doxycycline 100 mg PO BID × 10 d covers chlamydia and persistent gonococci. Single-agent FQ misses chlamydia and is inadequate for increasingly FQ-resistant gonococcal isolates per CDC 2021. Concurrent partner notification and HIV/syphilis screen are non-negotiable." },
      { q: "Why rule out torsion before starting antibiotics?",
        a: "Testicular torsion presents identically to acute epididymo-orchitis and is a surgical emergency — missing it costs the testicle within 6 h per AUA + EAU 2024 [cite:cdc_sti]. Doppler ultrasound for acute scrotal pain takes minutes and confirms perfusion. Empiric antibiotics without torsion exclusion delay surgical decompression and convert a salvageable testicle into orchiectomy. The diagnostic alarm is the acute presentation, not just the fever." },
      { q: "Why FQ for enteric etiology in older men?",
        a: "Workowski CDC 2021 + AUA 2024 [cite:cdc_sti] anchor FQ (levofloxacin or ciprofloxacin) × 10–14 d for the enteric substrate (age ≥ 35, insertive anal sex, instrumentation, BPH) — the Enterobacterales etiology requires tissue-penetrating coverage with prostatic activity. Doxycycline lacks the GNR spectrum for this substrate. TMP-SMX is the alternative when FQ-resistant. Urology workup for underlying BPH, stricture, or neurogenic bladder addresses recurrence prevention." },
    ],
    research: {
  ...
  renalabscess: {
    ...
    objections: [
      { q: "Why drain a > 3 cm abscess — antibiotics should reach it?",
        a: "Lin Mayo Clin Proc 2008 + EAU 2024 [cite:balance] anchor percutaneous catheter drainage for collections ≥ 3–5 cm because medical-only management has higher failure rates, longer total durations, and recurrent disease. The abscess cavity is poorly perfused — antibiotic concentrations within the necrotic core are inadequate for cure. Drainage also yields culture data that drives targeted narrowing. Surgical management is reserved for multiloculated lesions or PCD failure." },
      { q: "Why TEE if it's a kidney abscess?",
        a: "Hematogenous S. aureus seeding to the kidney implies an endovascular source — most commonly endocarditis or device-related bacteremia. Skipping TEE in S. aureus renal abscess drives recurrence at the original valvular focus and converts treatable disease into chronic relapse. IDSA SAB guidance [cite:balance] mandates TEE for S. aureus bacteremia with metastatic seeding. Treat per IE bands (4–6 wk) if vegetation found; persistent BCx > 72 h triggers source re-search." },
      { q: "Why 4–6 wk total — isn't 2 wk IV enough?",
        a: "Renal/perinephric abscess is a deep tissue infection requiring 4–6 wk total (≈ 2 wk IV + 2–4 wk oral step-down) from drainage day per Lin Mayo Clin Proc 2008 [cite:balance]. Serial imaging at 2–4 wk drives extension decisions. Short courses (< 4 wk) drive recurrence; long IV-only courses without oral step-down add line complications without benefit. Cipro or TMP-SMX per susceptibilities are the standard step-down options for adequate tissue penetration." },
    ],
    research: {
  ...
  "emphysematous-uti": {
    ...
    objections: [
      { q: "Why emergent surgery — can't we trial antibiotics first?",
        a: "Huang Kidney Int 2007 + AUA 2024 [cite:balance] show medical-only management of Class III–IV (parenchymal) emphysematous pyelonephritis has near-uniform failure with mortality 25–50%. Each hour of delay compounds mortality, and the diabetic metabolic substrate cannot be corrected fast enough to obviate surgery. Class I (collecting system gas only) is drainage-treatable; Class II usually requires PCD + broad antibiotics; Class III–IV most often requires emergent nephrectomy. CT for class stratification drives the surgical alarm." },
      { q: "Why pip-tazo or carbapenem and not narrower coverage?",
        a: "The dominant substrate is E. coli and Klebsiella with high rates of ESBL in diabetic and prior-antibiotic-exposed hosts per Huang 2007 [cite:balance]. Broad pip-tazo or carbapenem coverage is the empiric standard while susceptibilities return — under-coverage in a Class III–IV septic diabetic carries unacceptable mortality. Narrow on culture data within 48–72 h once susceptibility returns. Stewardship is preserved by de-escalation, not by reflexive narrow start." },
      { q: "Why glycemic control alongside antibiotics and surgery?",
        a: "DKA and hyperosmolar state are the metabolic substrate that drives outcomes per Huang 2007 [cite:balance] — uncontrolled hyperglycemia impairs leukocyte function, propagates gas-forming organism overgrowth, and worsens shock. Co-management with insulin protocol, fluid resuscitation, and electrolyte correction runs in parallel with the surgical pathway. HbA1c < 7 post-recovery reduces re-infection risk. The diabetic substrate is the disease — not just a comorbidity." },
    ],
    research: {
  ...
  "sepsis-abdominal": {
    ...
    objections: [
      { q: "Why 4 d post-source-control — shouldn't I treat to symptom resolution?",
        a: "STOP-IT NEJM 2015 [cite:stopit] established a fixed 4-d course after adequate source control non-inferior to symptom-guided extension — no difference in surgical-site infection, recurrence, or death. Extending therapy without an undrained focus drives resistance, C. difficile, and Candida overgrowth without changing outcomes. The contract is source control plus a defined stop date; symptoms beyond day 4 trigger imaging and surgical re-eval, not antibiotic extension." },
      { q: "Why no routine enterococcal cover in community IAI?",
        a: "Solomkin IDSA / SIS 2017 [cite:stopit] reserves anti-enterococcal coverage for HCAQ, postoperative, immunocompromised, or upper-GI source — community IAI in immunocompetent hosts does not require empiric ampicillin or vancomycin. Reflexive enterococcal cover wastes spectrum, selects VRE, and adds nephrotoxicity without survival benefit. Add coverage on culture data if enterococci grow as dominant or sole organism, or in the defined high-risk substrate." },
      { q: "Why echinocandin for upper-GI perforation but not all IAI?",
        a: "Candida overgrowth carries a mortality penalty in upper-GI perforation, postoperative leak, and recurrent IAI per Solomkin IDSA / SIS 2017 [cite:stopit] — the substrate has high Candida burden and translocation drives bloodstream seeding. Empiric echinocandin (caspofungin, micafungin, anidulafungin) at × 14+ d covers fluconazole-resistant species pending speciation. Community lower-GI perforation does not require empiric antifungal — reserve for the defined high-risk substrate to preserve echinocandin stewardship." },
      { q: "Why source-control review at 72 h instead of waiting longer?",
        a: "Antibiotic failure in abdominal sepsis most often reflects source-control failure — undrained collections, anastomotic leak, partial resection — not the wrong drug per STOP-IT + Solomkin [cite:stopit]. The 48–72 h reassessment with imaging, drain function review, and surgical re-eval is the contract. Waiting longer compounds mortality; the STOP-IT 4-d bands assume responsive clinical course. Persistent or worsening signs trigger repeat CT and surgical re-exploration." },
    ],
    research: {
  ...
  "transplant-uti": {
    ...
    objections: [
      { q: "Why treat early-post-tx ASB but not later ASB?",
        a: "AST IDCOP 2019 + Nicolle IDSA 2019 [cite:balance] anchor a treat-the-asymptomatic stance only in the first 3 months post-transplant — graft tolerance, indwelling ureteric stent, and high-intensity immunosuppression converge to make ASB clinically significant in this window. Beyond 3 months, ASB treatment drives resistance, AKI, and C. difficile without preventing symptomatic UTI per Nicolle. The window is the indication, not the bacteriuria itself." },
      { q: "Why broad empirics if the patient was previously responsive?",
        a: "Transplant cohort UTI carries a high ESBL and carbapenem-resistant baseline due to repeated antibiotic exposure, prior catheterization, and healthcare contact per AST 2019 [cite:balance]. Empiric narrow ceftriaxone risks under-treatment in a high-acuity immunocompromised host. Broader empiric (carbapenem when prior MDR positive) with rapid de-escalation at 48–72 h on culture data balances safety with stewardship. Prior susceptibility history drives the empiric choice." },
      { q: "Why screen drug-immunosuppressant interactions every time?",
        a: "Calcineurin-inhibitor levels are exquisitely sensitive to common antibiotics — fluoroquinolones and macrolides raise tacrolimus levels (toxicity, nephrotoxicity, neurotoxicity), while rifampin drops them (rejection risk). Fishman NEJM 2007 [cite:fishman] anchors mandatory transplant ID coordination because each new antibiotic episode requires level monitoring and dose adjustment. The interaction screen is not optional — graft loss from tacrolimus drift outweighs UTI cure benefit." },
    ],
    research: {
  ...
  pid: {
    ...
    objections: [
      { q: "Why metronidazole — isn't CTX + doxy already enough?",
        a: "Workowski CDC MMWR 2021 [cite:cdc_sti] added metronidazole back to the outpatient regimen because anaerobes (Bacteroides, Prevotella) contribute meaningfully to upper-tract disease and long-term sequelae (infertility, chronic pain, ectopic). Bacterial-vaginosis co-infection drives recurrence and metronidazole addresses both. The triple coverage (CTX 500 mg IM × 1 + doxy 100 mg PO BID + metro 500 mg PO BID × 14 d) is the current standard — dropping metronidazole returns to the era of higher long-term sequelae." },
      { q: "Why not remove the IUD reflexively?",
        a: "ACOG 2022 + CDC 2021 [cite:cdc_sti] support IUD retention if the patient is responding at 48–72 h — removal does not change PID outcomes per Ness CID 2002 and complicates contraception management with risk of unintended pregnancy in a treated host. Remove only if no improvement by 48–72 h, severe disease, or patient request. The IUD is not the disease driver; the polymicrobial pelvic infection is." },
      { q: "Why drain TOA at 8 cm and not always?",
        a: "Wiesenfeld AJOG 2017 [cite:cdc_sti] anchors drainage for TOA > 8 cm or non-response by 72 h — smaller responding lesions resolve with IV antibiotics alone, and reflexive drainage adds procedural morbidity without benefit. > 8 cm or non-response triggers IR or gyn drainage with culture data driving targeted narrowing. Inpatient IV (cefoxitin or cefotetan + doxy, or clinda + gent) is the substrate; outpatient with PO follow-up is inappropriate for TOA." },
      { q: "Why partner notification — patient is the one being treated?",
        a: "Re-infection from an untreated partner is the dominant recurrence driver per Workowski CDC 2021 [cite:cdc_sti]. Untreated gonorrhea and chlamydia in male partners reseed the index patient and propagate community transmission. Expedited partner therapy (EPT) where legally permitted reduces re-infection rates substantially. HIV, syphilis, and hepatitis screen at PID diagnosis is mandatory — STI clustering is high and the visit is a public-health opportunity." },
    ],
    research: {
  ...
  "asymp-bact": {
    ...
    objections: [
      { q: "Why not treat — the urine culture is positive?",
        a: "Nicolle IDSA 2019 [cite:balance] explicitly recommends against treating asymptomatic bacteriuria in elderly, catheterized, diabetic, spinal-cord-injured, and functionally disabled hosts because antibiotic exposure drives resistance, AKI, and C. difficile without preventing symptomatic UTI. The validated exceptions are narrow: pregnancy and pre-urologic-instrumentation only. Positive culture without symptoms is colonization, not infection — stewardship displaces reflexive prescription." },
      { q: "Why treat pregnancy ASB if elderly ASB is not treated?",
        a: "Pregnancy ASB is the validated treatment indication per Nicolle IDSA 2019 [cite:balance] — untreated ASB drives preterm birth, low birth weight, and progression to pyelonephritis (20–30% incidence without treatment) per multiple RCTs. Treat with nitrofurantoin (avoid term + G6PD), amoxicillin, or cephalexin × 5–7 d per sensitivity. Post-treatment culture confirms clearance. The risk-benefit reverses in pregnancy because of fetal outcomes — not just maternal." },
      { q: "Why not treat delirium with positive urine culture in elderly?",
        a: "ASB is rarely the delirium cause per Trautner CID 2014 + Nicolle IDSA 2019 [cite:balance] — multiple confounders (dehydration, drug effect, hypoxia, infection elsewhere, structural brain disease) dominate. Reflexive antibiotics for elderly + bacteriuria + altered mental status delays the real diagnosis and exposes the patient to AKI and C. difficile. Broader workup precedes antibiotics. Cloudy urine and odor are also not indications — common in elderly and dehydrated." },
    ],
    research: {
  ...
  "scrotal-abscess": {
    ...
    objections: [
      { q: "Why differentiate simple abscess from Fournier so urgently?",
        a: "Fournier's gangrene carries 20–40% mortality and the dominant outcome lever is time-to-OR per Sorensen J Urol 2009 + Eke Br J Surg 2000 [cite:ssti]. Simple drained scrotal abscess gets I&D + 7 d per cellulitis bands; Fournier demands emergent CT, serial surgical debridement, ICU resuscitation, and polymicrobial coverage. Severe pain out of proportion, crepitus, skin necrosis, and diabetic substrate are the alarms. Misclassifying Fournier as simple abscess is uniformly fatal." },
      { q: "Why clindamycin in Fournier even if β-lactam covers susceptibilities?",
        a: "WSES 2018 [cite:ssti] retains clindamycin specifically for toxin suppression (Streptococcus pyogenes exotoxins, Clostridium α-toxin) — the ribosomal 50S block halts protein synthesis at the high inoculum where β-lactams falter (Eagle effect). Even when individual susceptibilities suggest β-lactam adequacy, the mechanistic anchor for limiting tissue damage during the debridement window is protein-synthesis inhibition. Continue clindamycin until toxin-producing organism excluded by culture." },
      { q: "Why diverting colostomy — that seems aggressive?",
        a: "Diverting colostomy is considered for extensive Fournier with perineal involvement per Sorensen J Urol 2009 [cite:ssti] — fecal stream diversion accelerates wound healing in the contaminated perineal field and prevents repeated source seeding during the long reconstruction phase. Not all Fournier requires it; the extent of perineal involvement and wound burden drives the decision. Multi-stage reconstructive surgery (flap or graft) follows debridement completion. Decision is multi-disciplinary (urology + GS + plastics)." },
    ],
    research: {
  ...
  "toxic-megacolon": {
    ...
    objections: [
      { q: "Why surgical consult day 1 when medical may work?",
        a: "Toxic megacolon mortality climbs > 30% with delayed colectomy per Ananthakrishnan Gut 2008 [cite:cdi] — surgical readiness must precede the decompensation. Colorectal surgery emergent consult at presentation enables rapid OR transfer if non-response by 48–72 h, perforation, or worsening dilation. Subtotal colectomy + end ileostomy is the rescue (preserving rectum for future reconstruction). Waiting until perforation or shock to consult costs mortality. The surgical alarm is on standby from the start." },
      { q: "Why no loperamide for symptom control?",
        a: "Antimotility agents, opiates, and anticholinergics are absolutely contraindicated per ACG 2021 [cite:cdi] — they worsen colonic dilation, mask the dilation trajectory that drives surgical timing, and delay the perforation alarm. Patient discomfort does not override the safety contract. Symptomatic management is fluid resuscitation, electrolyte correction, and treatment of the underlying disease (fulminant CDI vs IBD flare). The avoidance is non-negotiable regardless of patient or family pressure." },
      { q: "Why oral vanco 500 mg q6h plus IV metro for fulminant CDI?",
        a: "Fulminant CDI per IDSA / SHEA 2021 [cite:cdi] requires high-dose oral vancomycin 500 mg q6h (luminal concentration), IV metronidazole (systemic + serosal coverage during ileus when oral delivery is impaired), and rectal vancomycin (delivery to dilated colon when proximal flow is poor). Standard 125 mg q6h oral vanco is inadequate for the fulminant substrate. FMT post-recovery reduces recurrence per Ananthakrishnan. Surgical readiness runs in parallel." },
    ],
    research: {
  ...
  "mesenteric-isch": {
    ...
    objections: [
      { q: "Why antibiotics if this is a vascular problem?",
        a: "Bowel infarction drives bacterial translocation across the disrupted mucosal barrier — broad pip-tazo or carbapenem × 5–10 d addresses translocation-driven sepsis as bowel infarcts per Kassahun World J Surg 2008 [cite:stopit]. Antibiotics are adjunctive — the dominant outcome lever is revascularization within 6 h. Without surgery, antibiotics do not rescue. Perforation escalates to intra-abdominal sepsis bands. Coverage of anaerobes + GNR + GPC is mandatory for the translocation substrate." },
      { q: "Why not wait for peritonitis or acidosis to decide on surgery?",
        a: "Metabolic acidosis and peritonitis are late signs — by the time lactate rises and rebound tenderness emerges, bowel infarction is established and mortality jumps to 50–70% per Kassahun 2008 [cite:stopit]. The diagnostic window (CT angiography at presentation, emergent vascular consult) precedes laboratory derangement. ACR / SVS 2024 anchor the surgical alarm on symptom + imaging, not lab-driven. Each hour of delay compounds bowel loss. Aggressive early action preserves length." },
      { q: "Why second-look laparotomy at 24 h?",
        a: "Bowel viability is not always assessable at the initial operation — marginal segments may declare themselves over 12–24 h post-revascularization per Bjorck Eur J Vasc 2017 [cite:stopit]. Second-look laparotomy at 24 h re-assesses viability and resects newly necrotic segments, preserving length while preventing leak from non-viable retained bowel. Standard of care for extensive disease; selective for limited infarction. The decision is made before the first OR closure." },
    ],
    research: {
