    ...
    duration: {
      ...
      branches: [
        { label: "Community IAI, source controlled", days: "4 d",
          ...
          matchAgent: /ceftriaxone|piperacillin|ertapenem|metronidazole/i },
        { label: "Healthcare-associated / severe", days: "7–10 d",
          ...
          matchAgent: /piperacillin|meropenem|vancomycin/i },
    ...
    duration: {
      ...
      branches: [
        { label: "Successful drainage + susceptible organism", days: "4–7 d",
          ...
          matchAgent: /ceftriaxone|piperacillin|metronidazole/i },
        ...
        { label: "Bacteremic cholangitis", days: "7–10 d",
          ...
          matchAgent: /ceftriaxone|piperacillin|cefepime|meropenem/i },
        { label: "ESBL / CRE / healthcare flora", days: "10–14 d",
          detail: "Carbapenem or novel β-lactam; ID input mandatory",
          matchAgent: /meropenem|ertapenem|ceftolozane|ceftazidime-?avibactam/i },
      ],
      stopWhen: [
    ...
    duration: {
      ...
      branches: [
        { label: "Pyogenic, drained + susceptible", days: "4–6 wk total",
          ...
          matchAgent: /ceftriaxone|piperacillin|metronidazole|amoxicillin-?clavulanate/i },
        { label: "Hypervirulent K. pneumoniae", days: "≥ 6 wk + screen",
          ...
          matchAgent: /ceftriaxone|cefepime/i },
    ...
    duration: {
      ...
      branches: [
        ...
        { label: "Antibiotic-only management (selected)", days: "10 d",
          ...
          matchAgent: /ertapenem|piperacillin|amoxicillin-?clavulanate|ciprofloxacin|metronidazole/i },
      ],
      stopWhen: [
