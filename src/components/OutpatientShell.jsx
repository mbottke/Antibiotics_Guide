  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        textTransform:"uppercase", color:"var(--neon-cyan, var(--ox))", fontWeight:700, marginBottom:8,
    ...
    >
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{
          ...
          <Stethoscope size={11} style={{ verticalAlign:"-1px", color:"var(--electric-lime, var(--ox))" }}/>
        ...
        <div style={{
          ...
          <Hospital size={13} style={{ verticalAlign:"-2px", marginRight:6, color:"var(--neon-cyan, var(--ox))" }}/>
