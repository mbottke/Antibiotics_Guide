/* component/util · richText — shared **bold** parser + accented renderer.
   ...
   Drawer, PkPdBlock, and RegimenOptions. Wave 5 R2 consolidation —
   extracted to eliminate the 6× duplication tech-debt the UI audit
   surfaced (#14).

   USAGE
   -----
     import { RichText } from "../components/util/richText.jsx";
