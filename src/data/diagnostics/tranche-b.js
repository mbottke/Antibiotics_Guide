...
export const TRANCHE_B_DIAGNOSTICS = {
  ...
  endophthalmitis: {
    cultures: [
      ...
      { sev: "trigger",
        what: "Two sets of peripheral blood cultures if endogenous endophthalmitis suspected.",
        why:  "Endogenous endophthalmitis arises from bloodstream seeding; blood culture identifies remote focus." },
    ],
    panels: [
      { sev: "consider",
    ...
    imaging: [
      ...
      { sev: "trigger",
        what: "Echocardiogram and abdominal imaging if endogenous source suspected.",
        why:  "S. aureus IE and hepatic abscess (Klebsiella) are characteristic endogenous sources." },
    ],
  },
